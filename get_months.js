function getMonths(x) {
    ...
    switch(language) {
        case "af":
            ...
            break;
        case "ar":
            months = 'كانون الثاني يناير_شباط فبراير_آذار مارس_نيسان أبريل_أيار مايو_حزيران يونيو_تموز يوليو_آب أغسطس_أيلول سبتمبر_تشرين الأول أكتوبر_تشرين الثاني نوفمبر_كانون الأول ديسمبر''يناير_فبراير_مارس_أبريل_ماي_يونيو_يوليوز_غشت_شتنبر_أكتوبر_نونبر_دجنبر'.split('_');
            dd = 'يوم';
            mmm = 'شهر';
            break;
        case "ar-ma":
